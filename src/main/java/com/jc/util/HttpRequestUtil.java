...
public class HttpRequestUtil {
     ...
     * @throws IOException
     */
    public static String doGetByCookie(String url, String cookie) throws IOException {
        CloseableHttpClient httpClient = getHttpClient();
        HttpGet get = new HttpGet(url);
     ...
     * @throws IOException
     */
    public static String doPost(String url, Map<String, String> headers, String parameters, String contentType) throws IOException {
        String result = "";
